...
# 排除规则文件路径
BACKUP_EXCLUDE_FILE="${BACKUP_EXCLUDE_FILE:-/home/sandbox/.openclaw/workspace/infrastructure/backup_excludes.txt}"
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    OUTPUT_FILE="/home/sandbox/openclaw_backup_${TIMESTAMP}.tar.gz"
