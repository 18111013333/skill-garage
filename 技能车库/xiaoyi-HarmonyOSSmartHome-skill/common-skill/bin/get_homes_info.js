  ...
  try {
    ...
    if (response.data) {
      if (Array.isArray(response.data)) {
        ...
        rawHomes = response.data.houses;
      } else if (response.data.homes && Array.isArray(response.data.homes)) {
        rawHomes = response.data.homes;
      }
    } else if (response.result) {
      const resultData = Array.isArray(response.result) ? response.result : (response.result.houses || response.result.homes);
